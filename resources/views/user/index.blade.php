<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-slate-800 shadow sm:rounded-lg">
                <div class="w-full">
                    <div class="sm:flex sm:items-center">
                        <div class="sm:flex-auto">
                            <h1 class="text-base font-semibold leading-6 text-slate-500">{{ __('Users') }}</h1>
                            <p class="mt-2 text-sm text-white">A list of all the {{ __('Users') }}.</p>
                        </div>
                        ...
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
									...
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-white">Image</th>
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-white">Trusted</th>
                                    ...
                                    @foreach ($users as $user)
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-300">{{ $user->image }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-300">{{ $user->trusted }}</td>
